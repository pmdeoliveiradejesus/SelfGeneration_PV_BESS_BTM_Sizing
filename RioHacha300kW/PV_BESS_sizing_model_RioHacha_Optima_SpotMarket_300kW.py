...
#    Colombian Electricity Market      
     'lambda'  : 'lambdaColombia_localtime.inc', # 8760h 2024 Spot prices US/MWh, Null spot prices
     'psi'     : 'psiColombia_localtime.inc', # Tariff of Use of the network US/MWh, Null tariffs
     'Ppvu'    : 'PpvuRioHachaERAS20052023_localtime.inc',  # Profile Solar Las Vegas ERAS 2005-2023     
...
Plinst  = 300.0                    # kW peak/installed Load DataCenter
...
#m.addConstr(Wb <= 0.055*Wl) 
#m.addConstr(Ws == 0.00*Wl)
#m.addConstr(C == 5700, name='r10')
# m.addConstr(PinverterBESS == 2, name='r11')
#m.addConstr(Ppvinst    == 1500, name='r12')
